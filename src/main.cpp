...
unsigned int nStakeMinAge = 6 * 6 * 60; // 6 hours
...
const string strMessageMagic = "Planetpay Signed Message:\n";
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
	...
	if(nHeight >= 2 && nHeight <= 20000){
      ...
      nSubsidy = 10 * COIN;
    } else if(nHeight > 200000 && nHeight <= 220000){
      nSubsidy = 9 * COIN;
    } else if(nHeight > 220000 && nHeight <= 240000){
      nSubsidy = 8 * COIN; 
    } else if(nHeight > 240000 && nHeight <= 260000){
      nSubsidy = 7 * COIN; 
    } else if(nHeight > 260000 && nHeight <= 280000){
      nSubsidy = 6 * COIN; 
    } else if(nHeight > 280000 && nHeight <= 300000){
      nSubsidy = 5 * COIN; 
    } else if(nHeight > 300000 && nHeight <= 320000){
      nSubsidy = 4.8 * COIN; 
    } else if(nHeight > 320000 && nHeight <= 340000){
      nSubsidy = 4.6 * COIN;
    } else if(nHeight > 340000 && nHeight <= 360000){
      nSubsidy = 4.4 * COIN;
    } else if(nHeight > 360000 && nHeight <= 380000){
      nSubsidy = 4.2 * COIN;
    } else if(nHeight > 380000 && nHeight <= 400000){
      nSubsidy = 4 * COIN;
    } else if(nHeight > 400000 && nHeight <= 420000){
      nSubsidy = 3.8 * COIN;
    } else if(nHeight > 420000 && nHeight <= 440000){
      nSubsidy = 3.6 * COIN;
    } else if(nHeight > 440000 && nHeight <= 460000){
      nSubsidy = 3.4 * COIN; 
    } else if(nHeight > 460000 && nHeight <= 480000){
      nSubsidy = 3.2 * COIN; 
    } else if(nHeight > 480000 && nHeight <= 500000){
      nSubsidy = 3 * COIN; 
    } else if(nHeight > 500000 && nHeight <= 520000){
      nSubsidy = 2.8 * COIN; 
       } else{
      nSubsidy = 2.6 * COIN;
    }
        ...
        if(MasternodePayments)
        {
            ...
            if(IsProofOfStake() && pindex != NULL){
                if(pindex->GetBlockHash() == hashPrevBlock){
                    ...
                    CPlanetpaycoinAddress address2(address1);
...
{
    RenameThread("Planetpay-loadblk");
...
int64_t ret = 0; 
if (nHeight < 20000) {
        ret = blockValue * 0.05; // MN Reward 5%
    } else if (nHeight >= 20000 && nHeight <= 30000) {
        ret = blockValue * 0.70; // MN Reward 70%
    } else if (nHeight > 30000 && nHeight <= 40000) {
        ret = blockValue * 0.65; // MN Reward 65 %
    } else if (nHeight > 40000 && nHeight <= 50000) {
        ret = blockValue * 0.655; // MN Reward 65,5%
    } else if (nHeight > 50000 && nHeight <= 60000) {
       ret = blockValue * 0.66; // MN Reward 66%
    } else if (nHeight > 60000 && nHeight <= 70000) {
        ret = blockValue * 0.665; // MN Reward 66,5%
    } else if (nHeight > 70000 && nHeight <= 80000) {
        ret = blockValue * 0.67; // MN Reward 67%
    } else if (nHeight > 80000 && nHeight <= 90000 ) {
        ret = blockValue * 0.675; // MN Reward 67,5%
    } else if (nHeight > 90000 && nHeight <= 100000 ) {
        ret = blockValue * 0.68; // MN Reward 68%
    } else if (nHeight > 100000 && nHeight <= 110000 ) {
        ret = blockValue * 0.685; // MN Reward 68,5%
    } else if (nHeight > 110000 && nHeight <= 120000 ) {
        ret = blockValue * 0.69; // MN Reward 69%
    } else if (nHeight > 120000 && nHeight <= 130000 ) {
        ret = blockValue * 0.695; // MN Reward 69,5%
    } else if (nHeight > 130000 && nHeight <= 140000 ) {
        ret = blockValue * 0.70; // MN Reward 70%
    } else if (nHeight > 140000 && nHeight <= 150000 ) {
        ret = blockValue * 0.705; // MN Reward 70,5%
    } else if (nHeight > 150000 && nHeight <= 160000 ) {
        ret = blockValue * 0.71; // MN Reward 71%
    } else if (nHeight > 160000 && nHeight <= 170000 ) {
        ret = blockValue * 0.715; // MN Reward 71,5%
    } else if (nHeight > 170000 && nHeight <= 180000 ) {
        ret = blockValue * 0.72; // MN Reward 72%
    } else if (nHeight > 18000 && nHeight <= 190000 ) {
        ret = blockValue * 0.725; // MN Reward 72,5%
    } else if (nHeight > 190000 && nHeight <= 200000 ) {
        ret = blockValue * 0.73; // MN Reward 73%
    } else if (nHeight > 200000 && nHeight <= 210000) {
        ret = blockValue * 0.735; // MN Reward 73,5%
    } else if (nHeight > 210000 && nHeight <= 220000 ) {
        ret = blockValue * 0.74; // MN Reward 74%
    } else if (nHeight > 220000 && nHeight <= 230000 ) {
        ret = blockValue * 0.745; // MN Reward 74,5%
    } else if (nHeight > 230000 && nHeight <= 240000 ) {
        ret = blockValue * 0.75; // MN Reward 75%
    } else if (nHeight > 240000 && nHeight <= 250000 ) {
        ret = blockValue * 0.755; // MN Reward 75,5%
    } else if (nHeight > 250000 && nHeight <= 260000 ) {
        ret = blockValue * 0.76; // MN Reward 76%
    } else if (nHeight > 260000 && nHeight <= 270000 ) {
        ret = blockValue * 0.765; // MN Reward 76,5%
    } else if (nHeight > 270000 && nHeight <= 280000 ) {
        ret = blockValue * 0.77; // MN Reward 77%
    } else if (nHeight > 280000 && nHeight <= 290000 ) {
        ret = blockValue * 0.775; // MN Reward 77,5%    
    } else if (nHeight > 290000 && nHeight <= 300000 ) {
        ret = blockValue * 0.78; // MN Reward 78%
    } else if (nHeight > 300000 && nHeight <= 310000 ) {
        ret = blockValue * 0.785; // MN Reward 78,5%
    } else if (nHeight > 310000 && nHeight <= 320000 ) {
        ret = blockValue * 0.79; // MN Reward 79%
    } else if (nHeight > 320000 && nHeight <= 330000 ) {
        ret = blockValue * 0.795; // MN Reward 79,5%
    } else if (nHeight > 330000 && nHeight <= 340000 ) {
        ret = blockValue * 0.80; // MN Reward 80%
	} else if (nHeight > 340000 && nHeight <= 350000 ) {
        ret = blockValue * 0.805; // MN Reward 80,5%
    } else if (nHeight > 350000 && nHeight <= 360000 ) {
        ret = blockValue * 0.81; // MN Reward 81%
    } else if (nHeight > 360000 && nHeight <= 370000 ) {
        ret = blockValue * 0.815; // MN Reward 81,5%
    } else if (nHeight > 370000 && nHeight <= 380000 ) {
        ret = blockValue * 0.82; // MN Reward 82%
    } else if (nHeight > 380000 && nHeight <= 390000 ) {
        ret = blockValue * 0.825; // MN Reward 82,5%    
    } else if (nHeight > 390000 && nHeight <= 400000 ) {
        ret = blockValue * 0.83; // MN Reward 83%
    } else if (nHeight > 400000 && nHeight <= 410000 ) {
        ret = blockValue * 0.835; // MN Reward 83,5% 
    } else if (nHeight > 410000 && nHeight <= 420000 ) {
        ret = blockValue * 0.84; // MN Reward 84%
    } else if (nHeight > 420000 && nHeight <= 430000 ) {
        ret = blockValue * 0.845; // MN Reward 84,5%
    } else if (nHeight > 430000 && nHeight <= 440000 ) {
        ret = blockValue * 0.85; // MN Reward 85%
    } else if (nHeight > 440000 && nHeight <= 450000 ) {
        ret = blockValue * 0.855; // MN Reward 85,5%
    } else if (nHeight > 450000 && nHeight <= 460000 ) {
        ret = blockValue * 0.86; // MN Reward 86%
    } else if (nHeight > 460000 && nHeight <= 470000 ) {
        ret = blockValue * 0.865; // MN Reward 86,5%
    } else if (nHeight > 470000 && nHeight <= 480000 ) {
        ret = blockValue * 0.87; // MN Reward 87%
    } else if (nHeight > 480000 && nHeight <= 490000 ) {
        ret = blockValue * 0.875; // MN Reward 87,5%
    } else if (nHeight > 490000 && nHeight <= 500000 ) {
        ret = blockValue * 0.88; // MN Reward 88%
    } else if (nHeight > 500000 && nHeight <= 510000 ) {
        ret = blockValue * 0.885; // MN Reward 88,5%    
    } else if (nHeight > 510000 && nHeight <= 520000 ) {
        ret = blockValue * 0.89; // MN Reward 89%
    } else if (nHeight > 520000 && nHeight <= 530000 ) {
        ret = blockValue * 0.895; // MN Reward 89,5%
    } else if (nHeight > 530000) {
                ret = blockValue * 0.90; // MN Reward 90%
       }
    return ret;
}
