...
void tradingDialog::ParseAndPopulateOrderBookTables(QString OrderBook){
    ...
    ui->TOKSupply->setText("<b>Supply:</b> <span style='font-weight:bold; font-size:12px; color:blue'>" + str.number(TOKSupply,'i',8) + "</span><b> PLT</b>");
    ...
    ui->TOKDemand->setText("<b>Demand:</b> <span style='font-weight:bold; font-size:12px; color:blue'>" + str.number(TOKDemand,'i',8) + "</span><b> PLT</b>");
...
void tradingDialog::ActionsOnSwitch(int index = -1){
    ...
    switch (index){
                ...
                case 5://show balance tab
                    ...
                    Response = GetBalance("PLT");
                    if(Response.size() > 0 && Response != "Error"){
                        DisplayBalance(*ui->TOKBalanceLabel,*ui->TOKAvailableLabel_2,*ui->TOKPendingLabel, QString::fromUtf8("PLT"),Response);
                    }
                break;
